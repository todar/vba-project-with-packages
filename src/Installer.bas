...
' ```
''
Public Sub Import(ByRef Project As VBProject, ByRef ComponentName As String, ByRef FullPath As String, Optional ByRef Overwrite As Boolean = False)
    Precheck Project
    
    '@TODO Need to get the module name
...
' ```
''
Public Sub Export(ByRef Project As VBProject, ByRef ComponentName As String, ByRef FullPath As String, Optional ByRef Overwrite As Boolean = False)
    Precheck Project
...
' ```
''
Public Sub Remove(ByRef Project As VBProject, ByRef ComponentName As String)
    Precheck Project
...
' ```
''
Public Sub AddReference(ByRef Project As VBProject, ByRef GUID As String, ByRef MajorVersion As Long, ByRef MinorVersion As Long)
    Precheck Project
...
' ```
''
Public Sub RemoveReference(ByRef Project As VBProject, ByRef GUID As String, ByRef MajorVersion As Long, ByRef MinorVersion As Long)
    Precheck Project
...
Private Function GetComponent(ByRef Project As VBProject, ByRef ComponentName As String) As VBComponent
    On Error Resume Next
    Set GetComponent = Project.VBComponents.item(ComponentName)

    On Error GoTo 0
End Function

Private Function GetReference(ByRef Project As VBProject, ByRef GUID As String, ByRef MajorVersion As Long, ByRef MinorVersion As Long) As Reference
...
Private Sub Precheck(ByRef Project As VBProject)
...
Private Function VbaIsUnlocked(ByRef Project As VBProject) As Boolean
    If Project.Protection = vbext_ProjectProtection.vbext_pp_none Then
        VbaIsUnlocked = True
    End If
End Function

Private Function VbaIsTrusted(ByRef Project As VBProject) As Boolean
    On Error Resume Next
